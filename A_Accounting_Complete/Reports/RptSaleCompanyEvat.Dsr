VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} RptSaleCompanyEvat 
   ...
   _ExtentX        =   26882
   _ExtentY        =   19420
   SectionData     =   "RptSaleCompanyEvat.dsx":0000
End
Attribute VB_Name = "RptSaleCompanyEvat"
...
'SQL = "select * from qryRefund WHERE [AirlineID]=" & txtAirlineID
 'SQL = "select * from qryRefund WHERE [Refund Date] between #" & _
 '          Format(Me.lblFrom, "mm/dd/yyyy") & "# AND #" & _
 '          Format(Me.lblTo, "mm/dd/yyyy") & "# AND [AirlineID]=" & txtAirlineID
